...
def return_concentration(conc_int):
    global elective_preference
    if(conc_int == 1):
        elective_preference = software_systems_electives
    elif(conc_int == 2):
        elective_preference = data_science_electives
    elif(conc_int == 3):
        elective_preference = database_systems_electives
    elif(conc_int == 4):
        elective_preference = artificial_intelligence_electives
    elif(conc_int == 5):
        elective_preference = software_engineering_electives
    elif(conc_int == 6):
        elective_preference = game_and_real_time_systems_electives
    elif(conc_int == 7):
        elective_preference = software_engineering_electives


print(have_prereqs_for_electives(2, True, "Spring", 3))
